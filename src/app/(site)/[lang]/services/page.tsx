  ...
  return (
    <div className="bg-background">
      <PageIntro
        ...
        eyebrow={dict.meta.services.title}
      />
      ...
      <section className="section-pad bg-surface/30">
        <div className="container-page">
          <div className="flex flex-col items-center justify-between gap-8 rounded-3xl border border-white/10 bg-white/5 p-10 text-center md:flex-row md:text-left">
            <div>
              <h3 className="text-2xl font-bold text-foreground">{dict.home.cta.title}</h3>
              <p className="mt-2 text-muted">{dict.home.cta.description}</p>
            </div>
            <Link href={`/${lang}/contact`} className="btn-primary shrink-0">
              <span>{dict.home.cta.secondary}</span>
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </Link>
