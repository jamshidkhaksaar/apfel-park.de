...
export default function IPhoneBanner({
  ...
  return (
    ...
    >
        ...
        <div className={s.products} aria-label="iPhone Modelle">
          ...
          >
            <button
              className={s.zoom}
              type="button"
              aria-label="iPhone 18 Pro vergrößern"
              aria-pressed={pinned === "pro"}
              onFocus={() => setHovered("pro")}
              onBlur={() => setHovered(null)}
              onClick={() => togglePin("pro")}
            >
                ...
                <ProductImage
                  ...
                  alt={
                    proView
                      ...
                      : "iPhone 18 Pro – Apple Farbübersicht"
                  }
                />
              </span>
            </button>
          ...
          >
            <button
              className={s.zoom}
              type="button"
              aria-label="iPhone Duo vergrößern"
              aria-pressed={pinned === "duo"}
              onFocus={() => setHovered("duo")}
              onBlur={() => setHovered(null)}
              onClick={() => togglePin("duo")}
            >
              <span className={s.art}>
                <ProductImage key={duoSrc} src={duoSrc} alt="iPhone Duo – Apple Designansicht" />
                <video
                  ref={video}
                  className={s.video}
                  muted
      ...
      <p className={s.hint}>Modell berühren oder mit der Maus vergrößern</p>
      <button
        className={s.pause}
        type="button"
