...
export default function IPhoneBanner({
  ...
  const [theaterTab, setTheaterTab] = useState<"pro-0" | "pro-1" | "duo-0" | "duo-1" | "duo-video">("pro-0");
  ...
  function openTheater(tab: "pro-0" | "pro-1" | "duo-0" | "duo-1" | "duo-video") {
    setTheaterTab(tab);
    setTheaterOpen(true);
  }
          ...
          <div className={s.products} aria-label="iPhone Modelle">
            ...
            >
              <button
                className={s.zoom}
                type="button"
                aria-label="iPhone 18 Pro in Vollbild öffnen"
                onClick={() => openTheater(proView === 0 ? "pro-0" : "pro-1")}
              >
            ...
            <figure
              ...
              data-video-ready={String(film && videoReady)}
            ...
            >
              <button
                className={s.zoom}
                type="button"
                aria-label="iPhone Duo in Vollbild öffnen"
                onClick={() =>
                  openTheater(film ? "duo-video" : duoView === 0 ? "duo-0" : "duo-1")
                }
              >
                <div className={s.fullscreenBadge}>
                  <span>⤢</span>
              ...
              <figcaption className={s.name}>iPhone Duo</figcaption>
            ...
            <div className={s.theaterTitle}>
              ...
              <div>
                <h3 style={{ fontSize: "18px", fontWeight: "bold", margin: 0, color: "#fff" }}>
                  {theaterTab.startsWith("pro") ? "Apple iPhone 18 Pro & Pro Max" : "Apple iPhone Duo (Foldable)"}
                </h3>
                <span style={{ fontSize: "12px", color: "#e7c779" }}>
                  {theaterTab === "pro-0" && "Farbübersicht (Titanium Lineup)"}
                  {theaterTab === "pro-1" && "Vorder- und Rückseite (Variable Optik & Dynamic Island)"}
                  {theaterTab === "duo-0" && "Duo Titan Dunkel (7.6\" Innen-Display)"}
                  {theaterTab === "duo-1" && "Duo Titan Hell (Foldable Architektur)"}
