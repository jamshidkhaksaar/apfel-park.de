    ...
    const onScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          // Performance: Use window.innerHeight to avoid layout thrashing (forced reflow)
          // caused by reading scrollHeight during scroll events.
          // Show button after scrolling 1 viewport height.
