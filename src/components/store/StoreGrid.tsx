    ...
    <div className="flex flex-col gap-8 lg:flex-row">
      ...
      <aside className="w-full shrink-0 space-y-8 lg:w-64">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          <h3 id="categories-heading" className="mb-4 text-sm font-bold uppercase tracking-wider text-white">
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-4">
                ...
                <div className="mt-auto flex items-center justify-between border-t border-white/5 pt-3">
                  ...
                  <Link
                    href={`/${lang}/contact?device=${encodeURIComponent(product.title)}`}
                    className="text-[9px] font-bold uppercase tracking-wider text-muted-strong hover:text-gold transition-colors"
