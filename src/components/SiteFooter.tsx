        ...
        <div className="grid gap-12 py-16 lg:grid-cols-[1.4fr_1fr_1fr_1.3fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 rounded-md text-sm text-muted transition hover:text-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
              >
            ...
            <ul className="mt-6 space-y-3">
              {dict.footer.quickLinks.map((item: { label: string; path: string }) => (
                <li key={item.path}>
                  <Link 
                    href={`/${lang}${item.path}`} 
                    className="group flex items-center gap-2 rounded-sm text-sm text-muted transition hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
                  >
                    <svg className="h-3 w-3 text-gold opacity-0 transition group-hover:opacity-100 group-focus-visible:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
              ...
              {dict.footer.companyLinks.map((item: { label: string; path: string }) => (
                <li key={item.path}>
                  <Link 
                    ...
                    className="group flex items-center gap-2 rounded-sm text-sm text-muted transition hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
                  >
                    <svg className="h-3 w-3 text-amber opacity-0 transition group-hover:opacity-100 group-focus-visible:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
                    {item.label}
                  </Link>
          ...
          <div className="space-y-4">
            ...
            <Link
              ...
              target="_blank"
              className="inline-flex items-center gap-2 rounded-sm text-sm font-medium text-gold transition hover:text-gold-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
        ...
        {/* Social Media & Bottom Bar */}
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-t border-border pt-6 text-xs text-muted">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link 
                href="/login" 
                className="rounded-sm transition hover:text-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-surface"
              >
                Admin
              </Link>
            </div>
