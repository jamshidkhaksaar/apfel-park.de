            ...
            <ul className="mt-6 space-y-3">
              {dict.footer.quickLinks.map((item: { label: string; path: string }) => (
                <li key={item.path}>
                  ...
                  >
                    <svg className="h-3 w-3 text-gold opacity-0 transition group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
              ...
              {dict.footer.companyLinks.map((item: { label: string; path: string }) => (
                <li key={item.path}>
                  <Link 
                    ...
                    className="group flex items-center gap-2 text-sm text-muted transition hover:text-foreground"
                  >
                    <svg className="h-3 w-3 text-amber opacity-0 transition group-hover:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
                    {item.label}
                  </Link>
