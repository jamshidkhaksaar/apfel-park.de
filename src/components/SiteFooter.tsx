            ...
            <ul className="mt-6 space-y-3">
              {dict.footer.quickLinks.map((item: { label: string; path: string }) => (
                <li key={item.path}>
                  <Link 
                    href={`/${lang}${item.path}`} 
                    className="group flex items-center gap-2 text-sm text-muted transition hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-surface rounded-md px-1 -mx-1 py-0.5 -my-0.5"
                  >
            ...
            <ul className="mt-6 space-y-3">
              {dict.footer.companyLinks.map((item: { label: string; path: string }) => (
                <li key={item.path}>
                  <Link 
                    href={`/${lang}${item.path}`} 
                    className="group flex items-center gap-2 text-sm text-muted transition hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber focus-visible:ring-offset-2 focus-visible:ring-offset-surface rounded-md px-1 -mx-1 py-0.5 -my-0.5"
                  >
