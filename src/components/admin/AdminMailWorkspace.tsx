    ...
    () =>
      locale === "de"
        ? {
            ...
            manualPasswordHint: "Trage ein neues Passwort mit mindestens 8 Zeichen ein oder generiere eines. Beim Speichern wird es sofort auf dem Mailserver gesetzt.",
        ...
        : {
            ...
            manualPasswordHint: "Enter a new password with at least 8 characters or generate one. Saving applies it immediately on the mail server.",
