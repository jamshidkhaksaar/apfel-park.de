...
// Isolated clock component to prevent the parent AdminShell from re-rendering every second
function AdminClock() {
        ...
        <aside className="flex w-64 shrink-0 flex-col border-r border-white/5 bg-surface/40">
          ...
          <div className="px-5 pb-4 pt-6">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] tabular-nums text-muted/50"><AdminClock /></span>
            </div>
