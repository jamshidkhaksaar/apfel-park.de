...
// ⚡ Bolt: AdminClock isolates high-frequency clock state updates.
// This optimization prevents the entire large AdminShell component
// (and its nested layout trees) from re-rendering every 1000ms just to update the time.
function AdminClock() {
