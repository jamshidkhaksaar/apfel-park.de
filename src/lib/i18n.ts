      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "On the order confirmation we also show the Google Customer Reviews opt-in, again only if you allowed external services. If you accept there, we pass your email address, order number, delivery country, and estimated delivery date to Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Ireland, so that Google can send you a review survey. Without that consent the script is not loaded and no data is transferred.",
