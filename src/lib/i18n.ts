...
export const dictionary = {
  de: {
    ...
    nav: [
      ...
      { label: "Ersatzteile", path: "/parts" },
      { label: "Laptops", path: "/laptops" },
      { label: "Firmenkunden", path: "/firmenkunden" },
  ...
  en: {
    ...
    nav: [
      ...
      { label: "Laptops", path: "/laptops" },
      { label: "Business", path: "/firmenkunden" },
      { label: "Impressum", path: "/impressum" },
...
export const partsCatalogCopy = {
  de: {
    ...
    retailBody: 'Bestelle verfügbare Ersatzteile direkt im Shop. Prüfe Modell, Variante und Kompatibilität in den Produktdetails. Für Fragen zur Auswahl oder zum Einbau beraten wir dich gerne.',
    wholesaleTitle: 'Großhandel für Werkstätten & Händler',
    wholesaleBody: 'Für größere Stückzahlen oder regelmäßigen Bedarf: Nenne uns Modelle, Artikel und Mengen. Du erhältst ein individuelles Angebot mit bestätigten Preisen, Verfügbarkeit und Lieferzeit.',
    quote: 'Großhandelsangebot anfragen', business: 'Firmenkunden & B2B',
    compatibility: 'Das genaue Gerätemodell und die Ausführung müssen zum Ersatzteil passen. Teilepreise enthalten keinen Einbau. Bei Fragen zum Einbau nutze unseren Reparaturservice.',
    repairs: 'Reparaturservice ansehen',
  },
  en: {
    ...
    retailBody: 'Order available parts directly from the store. Check the model, variant and compatibility in the product details. Contact us for help choosing a part or arranging installation.',
    wholesaleTitle: 'Wholesale for repair shops & retailers',
    wholesaleBody: 'For larger quantities or recurring orders, send us the models, items and quantities. We will provide an individual quote with confirmed pricing, availability and delivery time.',
