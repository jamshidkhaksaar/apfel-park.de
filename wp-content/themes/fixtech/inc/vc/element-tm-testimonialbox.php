...
$allParams = array_merge(
	...
	array(
		...
		array(
			...
			"param_name"  => "show",
			"description" => esc_attr__("Total Testimonials you want to show.", "fixtech"),
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show sortable category links above Testimonial boxes so user can sort by category by just single click.",'fixtech'),
			"param_name"  => "sortable",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show pagination links below Testimonial boxes.",'fixtech'),
		...
		array(
			...
			"param_name"  => "category",
			"description" => esc_attr__("Select group so it will show Testimonials from selected group only.", "fixtech"),
...
vc_map( array(
	"name"     => esc_attr__("ThemetechMount Testimonial Box", "fixtech"),
