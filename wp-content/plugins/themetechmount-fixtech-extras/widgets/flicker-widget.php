 ...
 * @since 1.0
 */
class fixtech_flicker_widget extends WP_Widget {
	...
	function __construct() {
		$widget_style = array('classname'   => 'fixtech_flicker_widget',
							  'description' => esc_attr__('Show photos from Flickr.','fixtech') );
		...
		$control_styles = array('width'   => 300,
								'height'  => 350,
								'id_base' => 'fixtech_flicker_widget');
		...
		parent::__construct(
			'fixtech_flicker_widget', // Base ID
			esc_attr__('Fixtech Flickr Widget', 'fixtech'), // Name
			$widget_style // Args
		);
	}
	...
	function widget( $args, $cur_instance ) {
		...
		echo '<div class="fixtech_flicker_widget_wrapper">'; ?>
	...
	function form( $cur_instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo esc_attr__('Title', 'fixtech'); ?>:</label>
...
register_widget( 'fixtech_flicker_widget' );